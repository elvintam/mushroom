...
```{r svmLinear, echo=TRUE, warning=FALSE}
...
```{r Classification, echo=TRUE, warning=FALSE}
...
```{r gamLoess, echo=TRUE, warning=FALSE}
...
```{r multinom, echo=TRUE, warning=FALSE}
