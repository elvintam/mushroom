...
According to description from the source, there is data missing in the attribute of stalk root. The missing data point is marked “?” from the source already. Veil type is reported 1 level only. As a result, both stalk root and veil type are removed prior to we start data exploration & modeling.
...
plot_bar(mushroom, by = "class", nrow = 2L, ncol = 4L)
